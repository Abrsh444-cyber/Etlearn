              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (onOpenInAppViewer) {
                    onOpenInAppViewer(syncDocUrl, "Your Google Doc");
                  } else {
                    window.open(syncDocUrl, "_blank");
                  }
                }}
                className="text-emerald-400 font-bold hover:underline flex items-center gap-1 text-[11px] bg-transparent border-0 cursor-pointer p-0"
              >
            ...
            {syncSheetUrl && (
              <button
                ...
                onClick={() => {
                  playSuccessChime();
                  if (onOpenInAppViewer) {
                    onOpenInAppViewer(syncSheetUrl, "Your Google Sheet");
                  } else {
                    window.open(syncSheetUrl, "_blank");
                  }
                }}
                className="text-[#C8962E] font-bold hover:underline flex items-center gap-1 text-[11px] bg-transparent border-0 cursor-pointer p-0"
              >
